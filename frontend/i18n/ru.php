...
return array(
    ...
    'date'       => array(
        ...
        'days_back_less'    => 'Менее дня назад',
        'weeks_back'        => '%%weeks%% неделя назад; %%weeks%% недели назад; %%weeks%% недель назад',
        'weeks_back_less'   => 'Менее недели назад',
        'months_back'       => '%%months%% месяц назад; %%months%% месяца назад; %%months%% месяцев назад',
        'months_back_less'  => 'Менее месяца назад',
        'years_back'       => '%%years%% год назад; %%years%% года назад; %%years%% лет назад',
        'years_back_less'  => 'Менее года назад',
        'month_array'       => array(
